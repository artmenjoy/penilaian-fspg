...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Manajemen Grup Akses</h3>
        </div>
	</div>
	...
	<div class='row'>
		<div class='col-lg-12'>
			...
			<p><a href='?module=<?=$mod;?>&act=tambah<?=$mod;?>' class='btn btn-primary'><span>Tambahkan Grup Akses</span></a></p>
			<? } ?>
			
			<div class='panel panel-default'>
				<div class='panel-heading'>Grup Akses</div>
	...
	<div class='row'>
		<div class='col-lg-12'>
			...
			<div class='panel panel-default'>
				<div class='panel-heading'>Tambah Grup Akses</div>
				<div class="panel-body">
	...
	<div class='row'>
		<div class='col-lg-12'>
			...
			<div class='panel panel-default'>
				<div class='panel-heading'>Edit Grup Akses</div>
				<div class="panel-body">
